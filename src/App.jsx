      ...
      <li>
        <div className="book">
          <div className="book-top">
            ...
            <ShelfChanger book={{ title: this.props.title }} shelf={ this.props.shelf }/>
          </div>
              ...
              <div className="list-books-content">
                <div>
                  <BookShelf title="Currently Reading">
                    {this.state.currentlyReading.map(b => <Book {...b} shelf="currentlyReading"/>)}
                  </BookShelf>
                  <BookShelf title="Want to Read">
                    {this.state.wantToRead.map(b => <Book {...b} shelf="wantToRead"/>)}
                  </BookShelf>
                  <BookShelf title="Read">
                    {this.state.read.map(b => <Book {...b} shelf="read"/>)}
                  </BookShelf>
                </div>
              </div>
